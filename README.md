...
*   **Search History**: Quickly re-access your recent searches with a single click.
...
2. Double-click `weather.html` to open it in your browser.

### Option 2: Local Server (Recommended)
If you're using VS Code, use the **Live Server** extension or run:
```bash
...
---
*Note: The API key in this project is hardcoded for demo purposes and ease of use. If you plan to scale this, please use environment variables or a proxy to keep your keys secure.*
